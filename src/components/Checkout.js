    ...
    <div>
      ...
      <div className="row bg-info bg-opacity-10">
        ...
        <div className="col-12">
          Mobile:
          {' '}
          <input type="text" name="mobile" onChange={handleChange} value={orderDetails.mobile} />
          <br />
          Address:
          {' '}
          <input type="text" name="address" onChange={handleChange} value={orderDetails.address} />
          <br />
          PinCode:
          {' '}
          <input type="text" name="pincode" onChange={handleChange} value={orderDetails.pincode} />
          <br />
